            ...
            <div className="rounded-2xl bg-gray-800 p-6 shadow-2xl">
              ...
              <div className="space-y-3">
                ...
                <Link
                  ...
                  className="flex items-center gap-3 rounded-lg bg-purple-500/10 border border-purple-500/20 p-4 transition-all hover:bg-purple-500/20"
                >
                  ...
                  <div>
                    <p className="font-semibold text-white">Review Donations</p>
                    <p className="text-xs text-gray-400">Approve item donations</p>
                  </div>
                </Link>
